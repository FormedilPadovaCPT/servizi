...
(function () {
  ...
  var SITUAZIONI = [
    ...
    { id: 'formazione', nome: 'Formazione e strumenti', frase: 'Corsi per i lavoratori e applicativi online', pagine: ['iscrizioni', 'progetti', 'cor', 'cds', 'myapp'] },
  ...
  var PAROLE = {
    ...
    progetti: 'progetti finanziati spisal sicuri si diventa soft skills alternanza scuola lavoro stage tutor materiali',
  ...
  var ICONE = {
    ...
    progetti: '<path d="M5 21V4.5h10l-1.2 3 1.2 3H5"/><path d="M5 4.5V3"/>',
